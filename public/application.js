...
var updateRecipe = function updateRecipe(data, recipeId) {
  return $.ajax({
    method: 'PATCH',
    data: { recipe: data },
...
var authEvents = __webpack_require__(10); // your JS code goes here
var authEventsRecipes = __webpack_require__(14);
...
var authUi = __webpack_require__(13);
...
var onSignIn = function onSignIn(event) {
  ...
  authApi.signIn(data).then(authUi.signInSuccess).catch(authUi.signInFail).then(authApi.getRecipes);
};
...
var onSignOut = function onSignOut(data) {
  event.preventDefault();
...
var apiUrl = void 0;
var apiUrls = {
  production: 'https://daily-foodie.herokuapp.com/',
...
var changePasswordFail = function changePasswordFail(response) {
  $('#content-msg').html('Sorry, you were not able to change your password,', 'Please try again !');
  $('#change-password-form').find('input').val('');
  $('.sign-up-form').find('input').val('');
  $('#sign-in-form').find('input').val('');
};
...
var getFormFields = __webpack_require__(4);
var authApi = __webpack_require__(5);
var authRecipeUi = __webpack_require__(15);

var onCreateRecipe = function onCreateRecipe(event) {
  event.preventDefault();
  var data = getFormFields(event.target);
  authApi.createRecipe(data).then(authRecipeUi.createRecipeSuccess).catch(authRecipeUi.createRecipeFail);
};

var onGetRecipes = function onGetRecipes(event) {
  event.preventDefault();
  authApi.getRecipes().then(authRecipeUi.showRecipes).then(authRecipeUi.getRecipesSuccess).catch(authRecipeUi.getRecipesFail);
};

var updateFormShow = function updateFormShow(event) {
  event.preventDefault();
  console.log(event);
...
var onUpdateRecipe = function onUpdateRecipe(event) {
  ...
  authApi.updateRecipe(data, recipeId).then(authRecipeUi.updateRecipeSuccess).then(authApi.getRecipes).then(authRecipeUi.showRecipes).catch(authRecipeUi.updateRecipeFail);
...
var onDeleteRecipe = function onDeleteRecipe(event) {
  event.preventDefault();
  var recipeId = $(event.target).attr('data-id');
  authApi.deleteRecipe(recipeId).then(authRecipeUi.deleteRecipeSuccess).then(authApi.getRecipes).then(authRecipeUi.showRecipes).catch(authRecipeUi.deleteRecipeFail);
};
...
// const authEventsRecipes = require('./eventsRecipes.js')
var showRecipesTemplate = __webpack_require__(16);
// const getFormFields = require('../../../lib/get-form-fields.js')

var showRecipes = function showRecipes(data) {
  store.recipes = data.recipes;
  var showRecipesHtml = showRecipesTemplate({
...
var createRecipeFail = function createRecipeFail(response) {
  $('#content-msg').html('<h7>We could not create your recipe, please try again !</h7>');
  $('#create-recipe-form').find('input').val('');
  $('#get-all-recipes').show();
};

var getRecipesSuccess = function getRecipesSuccess(data) {
...
var getRecipesFail = function getRecipesFail(response) {
  $('#content-msg').html('<h7>We could not find your recipes. Please try again !</h7>');
};

var updateRecipeSuccess = function updateRecipeSuccess() {
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
  ...
  return "  <div class=\"col-sm-6 recipe-box card\">\n    <h5 data-id=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\" class=\"recipe-list\"> Name: "
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.name : stack1), depth0))
    + "</h5>\n    <ul data-id=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\">\n      <li>\n        <h5> "
    + ((stack1 = helpers["if"].call(alias3,((stack1 = blockParams[0][0]) != null ? stack1.steps : stack1),{"name":"if","hash":{},"fn":container.program(2, data, 0, blockParams),"inverse":container.program(4, data, 0, blockParams),"data":data,"blockParams":blockParams})) != null ? stack1 : "")
    + "</h5></li>\n      <li>\n        <h5>"
    + ((stack1 = helpers["if"].call(alias3,((stack1 = blockParams[0][0]) != null ? stack1.link : stack1),{"name":"if","hash":{},"fn":container.program(6, data, 0, blockParams),"inverse":container.program(8, data, 0, blockParams),"data":data,"blockParams":blockParams})) != null ? stack1 : "")
    + "</h5> </li>\n\n      <button class=\"btn btn-default delete-recipe\" data-class=\"delete-recipe\" data-id='"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "'>Remove recipe</button>\n\n      <form class=\"hide recipe-update-form update-form-"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\" data-id=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\">\n\n        <legend class=\"handlebar-legend\"><h5>Update Your Recipe:</h5></legend>\n        Update recipe name: <input name=\"name\" type=\"text\" placeholder=\"Update Recipe Name \" data-id=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\" class=\"update-recipe-name\" value=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.name : stack1), depth0))
    + "\"><br> Update recipe steps: <input name=\"steps\" type=\"text\" placeholder=\"Update the receipe steps\"\n          data-id=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\" value=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.steps : stack1), depth0))
    + "\"><br> Update recipe link: <input name=\"link\" type=\"text\" placeholder=\"Update the recipe URL\" data-id=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\" value=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.link : stack1), depth0))
    + "\" autocomplete=\"off\">\n        </fieldset>\n\n        <button type=\"submit\" class=\"update-one-recipe\">Save</button>\n\n</form>\n      <button data-id=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\" class=\"btn btn-default update-button\" type=\"submit\">Update Recipe</button>\n\n\n\n    </ul>\n  </div>\n";
},"2":function(container,depth0,helpers,partials,data,blockParams) {
    var stack1;

  return "\n    Recipe Steps : "
    + container.escapeExpression(container.lambda(((stack1 = blockParams[1][0]) != null ? stack1.steps : stack1), depth0))
    + "\n";
  ...
  return "\n    Recipe Link : "
    + container.escapeExpression(container.lambda(((stack1 = blockParams[1][0]) != null ? stack1.link : stack1), depth0))
    + "\n";
